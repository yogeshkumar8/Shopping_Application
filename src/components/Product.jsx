...
const Product = ({post}) => {
  ...
  return (
      ...
      hover:scale-110 transition duration-300 ease-in gap-3 p-4 mt-9 ml-5 rounded-xl border-[2px]">
        <div>
          <p className="text-gray-700 text-lg font-semibold text-left truncate
